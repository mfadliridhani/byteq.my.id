...
>
    <head>
        ...
        <title>
            Landing Page - Front Pages | Sneat - Bootstrap 5 HTML Admin Template
            - Pro
        </title>
                                ...
                                <div class="dropdown-menu p-4">
                                    <div class="row gy-4">
                                        <div class="col-12 col-lg">
                                            <div
                                                class="h6 d-flex align-items-center mb-2 mb-lg-3"
                                            >
                                                <div
                                                    class="avatar avatar-sm flex-shrink-0 me-2"
                                                >
                                                    <span
                                        ...
                                        <div class="col-lg-4 d-none d-lg-block">
                                            <div
                                                class="bg-body nav-img-col p-2"
                                            >
                                                <img
                                                    src="{{ asset('../admin/assets/img/front-pages/misc/nav-item-col-img.png') }}"
                ...
                <div class="container">
                    <div class="row align-items-center gx-0 gy-4 g-lg-5">
                        <div class="col-md-6 col-lg-5 col-xl-3">
                            ...
                            <div
                                class="landing-reviews-btns d-flex align-items-center gap-3"
                            >
                                <button
                                    id="reviews-previous-btn"
                                    class="btn btn-label-primary reviews-btn"
                                    type="button"
                                >
                        ...
                        <div class="col-md-6 col-lg-7 col-xl-9">
                            <div
                                class="swiper-reviews-carousel overflow-hidden mb-5 pb-md-2 pb-md-3"
                            >
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card h-100">
                                                ...
                                                >
                                                    <div class="mb-3">
                                                        <img
                                                            src="{{ asset('../admin/assets/img/front-pages/branding/logo-1.png') }}"
                                                            alt="client logo"
                                                            class="client-logo img-fluid"
                                                        />
                                                    </div>
                                                    <p>
                                                        “Vuexy is hands down the
                                                        most useful front end
                                                        Bootstrap theme I've
                                                        ever used. I can't wait
                                                        to use it again for my
                                                        next project.”
                                                    </p>
                                                    <div
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card h-100">
                                                ...
                                                >
                                                    <div class="mb-3">
                                                        <img
                                                            src="{{ asset('../admin/assets/img/front-pages/branding/logo-2.png') }}"
                                                            alt="client logo"
                                                            class="client-logo img-fluid"
                                                        />
                                                    </div>
                                                    <p>
                                                        “I've never used a theme
                                                        as versatile and
                                                        flexible as Vuexy. It's
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card h-100">
                                                ...
                                                >
                                                    <div class="mb-3">
                                                        <img
                                                            src="{{ asset('../admin/assets/img/front-pages/branding/logo-3.png') }}"
                                                            alt="client logo"
                                                            class="client-logo img-fluid"
                                                        />
                                                    </div>
                                                    <p>
                                                        This template is really
                                                        clean & well documented.
                                                        The docs are really easy
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <img
                                                                src="{{ asset('../admin/assets/img/avatars/3.png') }}"
                                                                alt="Avatar"
                                                                class="rounded-circle"
                                                            />
                                                        </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card h-100">
                                                ...
                                                >
                                                    <div class="mb-3">
                                                        <img
                                                            src="{{ asset('../admin/assets/img/front-pages/branding/logo-4.png') }}"
                                                            alt="client logo"
                                                            class="client-logo img-fluid"
                                                        />
                                                    </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card h-100">
                                                ...
                                                >
                                                    <div class="mb-3">
                                                        <img
                                                            src="{{ asset('../admin/assets/img/front-pages/branding/logo-5.png') }}"
                                                            alt="client logo"
                                                            class="client-logo img-fluid"
                                                        />
                                                    </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card h-100">
                                                ...
                                                >
                                                    <div class="mb-3">
                                                        <img
                                                            src="{{ asset('../admin/assets/img/front-pages/branding/logo-6.png') }}"
                                                            alt="client logo"
                                                            class="client-logo img-fluid"
                                                        />
                                                    </div>
                    ...
                    <div class="swiper-logo-carousel py-4 my-lg-2">
                        <div class="swiper" id="swiper-clients-logos">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img
                                        src="{{ asset('../admin/assets/img/front-pages/branding/logo_1-light.png') }}"
                                        alt="client logo"
                                        class="client-logo"
                                ...
                                <div class="swiper-slide">
                                    <img
                                        src="{{ asset('../admin/assets/img/front-pages/branding/logo_2-light.png') }}"
                                        alt="client logo"
                                        class="client-logo"
                                ...
                                <div class="swiper-slide">
                                    <img
                                        src="{{ asset('../admin/assets/img/front-pages/branding/logo_3-light.png') }}"
                                        alt="client logo"
                                        class="client-logo"
                                ...
                                <div class="swiper-slide">
                                    <img
                                        src="{{ asset('../admin/assets/img/front-pages/branding/logo_4-light.png') }}"
                                        alt="client logo"
                                        class="client-logo"
                                ...
                                <div class="swiper-slide">
                                    <img
                                        src="{{ asset('../admin/assets/img/front-pages/branding/logo_5-light.png') }}"
                                        alt="client logo"
                                        class="client-logo"
                    ...
                    <div class="row gy-5 mt-2">
                        <div class="col-lg-3 col-sm-6">
                            <div class="card mt-3 mt-lg-0 shadow-none">
                                <div
                                    class="bg-label-primary position-relative team-image-box"
                                >
                                    <img
                                        src="{{ asset('../admin/assets/img/front-pages/landing-page/team-member-1.png') }}"
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="card mt-3 mt-lg-0 shadow-none">
                                <div
                                    class="bg-label-info position-relative team-image-box"
                                >
                                    <img
                                        src="{{ asset('../admin/assets/img/front-pages/landing-page/team-member-2.png') }}"
                                        class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                                        alt="human image"
                                    />
                                </div>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="card mt-3 mt-lg-0 shadow-none">
                                <div
                                    class="bg-label-danger position-relative team-image-box"
                                >
                                    <img
                                        src="{{ asset('../admin/assets/img/front-pages/landing-page/team-member-3.png') }}"
                                        class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                                        alt="human image"
                                    />
                                </div>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="card mt-3 mt-lg-0 shadow-none">
                                <div
                                    class="bg-label-success position-relative team-image-box"
                                >
                                    <img
                                        src="{{ asset('../admin/assets/img/front-pages/landing-page/team-member-4.png') }}"
                                        class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                                        alt="human image"
                                    />
                                </div>
            ...
            <section id="landingFAQ" class="section-py bg-body landing-faq">
                <div class="container">
                    ...
                    <p class="text-center mb-5 pb-3">
                        Browse through these FAQs to find answers to commonly
                        asked questions.
                    </p>
                    <div class="row gy-5">
                        <div class="col-lg-5">
                            <div class="text-center">
                                <img
                                    src="{{ asset('../admin/assets/img/front-pages/landing-page/faq-boy-with-logos.png') }}"
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                <div class="card accordion-item">
                                    ...
                                    >
                                        ...
                                        >
                                            Do I need to purchase a license for
                                            each website?
                                        </button>
                                    </h2>
                                    <div
                                ...
                                <div class="card accordion-item">
                                    ...
                                    >
                                        <div class="accordion-body">
                                            Regular license can be used for end
                                            products that do not charge users
                                            for access or service(access is free
                                            and there will be no monthly
                                            subscription fee). Single regular
                                            license can be used for single end
                                            product and end product can be used
                                            by you or your client. If you want
                                            to sell end product to multiple
                                            clients then you will need to
                                            purchase separate license for each
                                            client. The same rule applies if you
                                            want to use the same end product on
                                            multiple domains(unique setup). For
                                            more info on regular license you can
                                            check official description.
                                        </div>
                                    </div>
                                </div>
                                <div class="card accordion-item">
                                    ...
                                    >
                                        <div class="accordion-body">
                                            ...
                                            et aliquid quaerat possimus maxime!
                                            Mollitia reprehenderit neque
                                            repellat delenibx delectus
                                            architecto dolorum maxime,
                                            blanditiis earum ea, incidunt quam
                                            possimus cumque.
                                        </div>
                                    </div>
                                </div>
                                <div class="card accordion-item">
                                    ...
                                    >
                                        ...
                                        >
                                            Which license is applicable for SASS
                                            application?
                                        </button>
                                    </h2>
                                    <div
                                    ...
                                    >
                                        <div class="accordion-body">
                                            ...
                                            molestias exercitationem ab cum nemo
                                            facere voluptates veritatis quia,
                                            eveniet veniam at et repudiandae
                                            mollitia ipsam quasi labore enim
                                            architecto non!
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row gx-0 gy-4 g-md-5">
                        <div class="col-lg-5">
                            ...
                            >
                                ...
                                <span
                                    class="app-brand-text demo footer-link fw-bold ms-2 ps-1"
                                    >Sneat</span
                                >
                            </a>
                            <p class="footer-text footer-logo-description mb-4">
                                Most developer friendly & highly customisable
            ...
            <div class="footer-bottom py-3">
                ...
                >
                    <div class="mb-2 mb-md-0">
                        ...
                        <a
                            href="{{ asset('https://themeselection.com') }}"
                            target="_blank"
                    ...
                    <div>
                        <a
                            href="{{ asset('https://github.com/themeselection') }}"
                            class="footer-link me-3"
                            target="_blank"
                        >
                            <img
                                src="{{ asset('../admin/assets/img/front-pages/icons/github-light.png') }}"
                                alt="github icon"
                        ...
                        <a
                            href="{{ asset('https://www.facebook.com/ThemeSelections/') }}"
                            class="footer-link me-3"
                            target="_blank"
                        >
                            <img
                                src="{{ asset('../admin/assets/img/front-pages/icons/facebook-light.png') }}"
                                alt="facebook icon"
                        ...
                        <a
                            href="{{ asset('https://twitter.com/Theme_Selection') }}"
                            class="footer-link me-3"
                            target="_blank"
                        >
                            <img
                                src="{{ asset('../admin/assets/img/front-pages/icons/twitter-light.png') }}"
                                alt="twitter icon"
                        ...
                        <a
                            href="{{ asset('https://www.instagram.com/themeselection/') }}"
                            class="footer-link"
                            target="_blank"
                        >
                            <img
                                src="{{ asset('../admin/assets/img/front-pages/icons/instagram-light.png') }}"
                                alt="google icon"
